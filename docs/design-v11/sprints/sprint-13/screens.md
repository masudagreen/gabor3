...
> **Sprint 22 v1.2 改訂注記（2026-05-10、最重要）**：本スプリントの G-05 は **v1.2 で大幅改訂**された。「左右 2 ガボール直接選択」方式は廃止され、**3×3 グリッド + 違うパッチ複数ランダム + 複数選択 + TP+1/FP-1 部分点**方式に統合される（G-04 / G-06 と共通フォーマット）。最新仕様は `docs/design-v11/sprints/sprint-22/screens.md` §5 G-04 / G-05 / G-06 を参照。**本書 S13-01 / S13-02 / S13-03 の記述は履歴目的でのみ残置**。新規実装は sprint-22 を参照すること。
>
