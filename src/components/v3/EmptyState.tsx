/**
 * EmptyState.tsx — EM-1（components.md / F-09、v3.0）。
 *
 * データ少時・空時・エラー時の案内。アイコン + 文言 font.body 24px（components EM-1）。
 * 履歴 7 日未満「もう少しデータが集まると傾向が見えます」等に使う（F-09 受け入れ基準）。
 * 点滅なし（NF-11）。色のみに依存しない（テキストで案内、NF-12）。
 *
 * v2.0 の components/v2/EmptyState.tsx を v3 トークンに合わせて再実装した版。
 */
